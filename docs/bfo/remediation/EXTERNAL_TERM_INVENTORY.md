...
| `https://www.commoncoreontologies.org/ont00001921` | CCO has input | Superproperty of `hasInformationalInput` | Added in Phase 1 | **Verified, supplied, and reused** — CCO 2.2 ranges over the union of specifically dependent continuant, generically dependent continuant, and independent continuant that is not a spatial region; CCO 2.0 over `continuant`. Neither admits a process, so an ICE input is in range under both (corrected 2026-09-16; formal review N1) | Superseded by D-007: use directly with the ICE filler stated in the restriction, and retire `hasInformationalInput` |
| `https://www.commoncoreontologies.org/ont00001986` | CCO has output | Superproperty of `hasInformationalOutput` | Added in Phase 1 | **Verified, supplied, and reused** — CCO 2.2 ranges over the union of specifically dependent continuant, generically dependent continuant, and independent continuant that is not a spatial region; CCO 2.0 over `continuant`. Neither admits a process, so an ICE output is in range under both (corrected 2026-09-16; formal review N1) | Superseded by D-007: use directly with the ICE filler stated in the restriction, and retire `hasInformationalOutput` |
