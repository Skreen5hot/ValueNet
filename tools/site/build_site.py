...
def main(argv=None) -> int:
    ...
    # Generated data, produced into the artifact rather than committed.
    # Part of this build so "one deterministic build" stays true: a site
    # whose index is generated by a separate step can be deployed with an
    # index from a different commit.
    import importlib.util

    spec = importlib.util.spec_from_file_location(
        "build_class_index", _root / "tools/site/build_class_index.py")
